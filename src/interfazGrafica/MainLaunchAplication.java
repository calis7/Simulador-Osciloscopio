...
/**
 * El código que estás utilizando en el método main es una forma común de iniciar una aplicación Swing de manera correcta y fluida. 
 * Al utilizar SwingUtilities.invokeLater(new Runnable() { ... }), estás asegurando que la creación y visualización de la interfaz 
...
Si creas y muestras la interfaz gráfica directamente en el hilo principal, puede haber problemas de concurrencia y rendimiento, 
